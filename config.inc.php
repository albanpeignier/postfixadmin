...
include_once('/etc/postfixadmin/database.inc.php');
/*
 * Please, do not edit this Database settings.
 * The DBMS credentials are located in /etc/postfixadmin/database.inc.php
